...
(define (editor-or-not? a)
  (cond
    [(editor? a) #true]
    [else #false]))


(check-expect (editor-or-not? (make-editor "hello world" 6)) #true)
(check-expect (editor-or-not? (make-editor "hello world" -6)) #true)
(check-expect (editor-or-not? (make-editor 6 "hello world")) #true) ; #true -> str idx have no type, dynamic typed language.
(check-expect (editor-or-not? 0) #false)
(check-expect (editor-or-not? "hello world") #false)
