...
(define track1 (create-track "My song" "Joe Doe" "First album" 60.12 6 date1 666 date2))
(define track2 (create-track "Sing along" "Jane Doe" "Rythems" 90.0 12 date2 123 date1))
