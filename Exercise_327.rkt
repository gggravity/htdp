...
(define (add-node pair bst)
  (create-bst bst (first pair) (second pair)))

(define (create-bst-from-list l)
  (foldr add-node NONE l))

(check-expect (inorder (create-bst-from-list test-list)) '(10 15 24 29 63 77 89 95 99))

;; (foldl add-node NONE test-list)
;; (foldr add-node NONE test-list)

(check-expect (inorder (create-bst-from-list test-list2)) '(10 15 24 29 63 77 89 95 99))
